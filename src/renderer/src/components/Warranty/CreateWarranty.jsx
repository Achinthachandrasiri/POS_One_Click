...
const CreateWarranty = () => {
  ...
  const { createWarrantyType, loading, error } = useWarrantyTypeHooks()
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await createWarrantyType(form)
    ...
    <div className="relative min-h-full px-8 pt-8 pb-0 overflow-hidden">
      <div className="flex flex-col h-[630px]">
        ...
        <div className="relative z-10 mb-5">
          <h1 className="text-white text-[22px] font-semibold m-0">Create Warranty</h1>
          <p className="text-[#90bcc4] text-[15px] mt-1">Create a new warranty type</p>
        </div>
        ...
        >
          <form onSubmit={handleSubmit} className="max-w-xl">
            ...
            <div className="flex gap-3">
              ...
              >
                {loading ? 'Saving...' : 'Save Warranty Type'}
              </button>
