...
const EditBrand = () => {
  ...
  const [form, setForm] = useState({ brandName: '', imagePath: '' })
  ...
  const handleSubmit = async (e) => {
    ...
    if (res?.success) {
      ...
      setTimeout(() => navigate('/dashboard/products/brands'), 500)
    }
  }
    ...
    <div className="relative min-h-full px-8 pt-8 pb-0 overflow-hidden">
      <div className="flex flex-col h-[630px]">
        ...
        <div className="relative z-10 mb-5">
          <h1 className="text-white text-[22px] font-semibold m-0">Edit Brand</h1>
          <p className="text-[#90bcc4] text-[15px] mt-1">Update brand details</p>
        </div>
