import { useCreateQuotation, calcLineTotal, num } from '../../hooks/useCreateQuotation'
import {
    ...
    <div className="relative min-h-full px-8 pt-8 pb-0 overflow-hidden">
      ...
      <div className="flex flex-col h-[630px]">
        ...
        <div className="relative z-10 mb-5">
          <h1 className="text-white text-[22px] font-semibold m-0">Create Quotation</h1>
          <p className="text-[#90bcc4] text-[15px] mt-1">Enter quotation details to create a new quotation</p>
        </div>
        ...
        <div className="relative z-10 bg-white w-full px-10 py-10 shadow-xl rounded-t-[20px] overflow-auto" style={{ height: 'calc(100% - 70px)' }}>
          ...
          <div className="flex justify-end gap-3 pt-2 pb-6">
            ...
            >
              {loading ? (<><i className="fas fa-spinner fa-spin" /> Saving…</>) : (<><i className="fas fa-save" /> Save Quotation</>)}
            </button>
          </div>
        </div>
      </div>
