...
export const useCustomerHooks = () => {
  ...
  const createCustomer = async (form) => {
    ...
    try {
      ...
      const res = await window.api.customer.create(payload)
  ...
  const updateCustomer = async (id, form) => {
    ...
    try {
      ...
      const res = await window.api.customer.update(payload)
  ...
  const getCustomerById = async (id) => {
    ...
    try {
      const res = await window.api.customer.getById(id)
      if (!res?.success) {
  ...
  const deleteCustomer = async (id) => {
    ...
    try {
      const res = await window.api.customer.delete(id)
      if (!res?.success) {
